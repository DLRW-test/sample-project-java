...
public class SortTest {
  ...
  @Nested
  @DisplayName("SortVector(Vector<Integer> v) tests")
  class SortVectorTests {
    ...
    public void testSortVectorSingleElement() {
      Vector<Integer> v = new Vector<>(Arrays.asList(42));
      Sort.SortVector(v);
      Vector<Integer> expected = new Vector<>(Arrays.asList(42));
    ...
    public void testSortVectorAlreadySorted() {
      ...
      Sort.SortVector(v);
      Vector<Integer> expected = new Vector<>(Arrays.asList(1, 2, 3, 4, 5));
    ...
    public void testSortVectorReverseSorted() {
      Vector<Integer> v = new Vector<>(Arrays.asList(5, 4, 3, 2, 1));
      Sort.SortVector(v);
      Vector<Integer> expected = new Vector<>(Arrays.asList(1, 2, 3, 4, 5));
    ...
    public void testSortVectorRandomOrder() {
      Vector<Integer> v = new Vector<>(Arrays.asList(3, 1, 4, 1, 5, 9, 2, 6));
      Sort.SortVector(v);
      Vector<Integer> expected = new Vector<>(Arrays.asList(1, 1, 2, 3, 4, 5, 6, 9));
    ...
    public void testSortVectorWithDuplicates() {
      Vector<Integer> v = new Vector<>(Arrays.asList(3, 1, 3, 2, 1, 2, 3));
      Sort.SortVector(v);
      Vector<Integer> expected = new Vector<>(Arrays.asList(1, 1, 2, 2, 3, 3, 3));
    ...
    public void testSortVectorAllIdentical() {
      Vector<Integer> v = new Vector<>(Arrays.asList(7, 7, 7, 7, 7));
      Sort.SortVector(v);
      Vector<Integer> expected = new Vector<>(Arrays.asList(7, 7, 7, 7, 7));
    ...
    public void testSortVectorWithNegatives() {
      Vector<Integer> v = new Vector<>(Arrays.asList(-3, 5, -1, 0, 2, -8));
      Sort.SortVector(v);
      Vector<Integer> expected = new Vector<>(Arrays.asList(-8, -3, -1, 0, 2, 5));
      assertEquals(expected, v, "Vector with negative numbers should be sorted correctly");
    }
  }

  @Nested
  @DisplayName("DutchFlagPartition(Vector<Integer> v, int pivot) tests")
  class DutchFlagPartitionTests {
    ...
    public void testDutchFlagPartitionSingleLessThanPivot() {
      Vector<Integer> v = new Vector<>(Arrays.asList(3));
      Sort.DutchFlagPartition(v, 5);
      Vector<Integer> expected = new Vector<>(Arrays.asList(3));
    ...
    public void testDutchFlagPartitionSingleEqualPivot() {
      Vector<Integer> v = new Vector<>(Arrays.asList(5));
      Sort.DutchFlagPartition(v, 5);
      Vector<Integer> expected = new Vector<>(Arrays.asList(5));
    ...
    public void testDutchFlagPartitionSingleGreaterThanPivot() {
      Vector<Integer> v = new Vector<>(Arrays.asList(7));
      Sort.DutchFlagPartition(v, 5);
    ...
    public void testDutchFlagPartitionAllLessThanPivot() {
      Vector<Integer> v = new Vector<>(Arrays.asList(1, 2, 3, 4));
    ...
    public void testDutchFlagPartitionAllEqualPivot() {
      Vector<Integer> v = new Vector<>(Arrays.asList(5, 5, 5, 5));
      Sort.DutchFlagPartition(v, 5);
      Vector<Integer> expected = new Vector<>(Arrays.asList(5, 5, 5, 5));
    ...
    public void testDutchFlagPartitionAllGreaterThanPivot() {
      Vector<Integer> v = new Vector<>(Arrays.asList(10, 11, 12, 13));
      Sort.DutchFlagPartition(v, 5);
    ...
    public void testDutchFlagPartitionMixedValues() {
      Vector<Integer> v = new Vector<>(Arrays.asList(3, 5, 2, 5, 1, 8, 5, 9, 4));
      Sort.DutchFlagPartition(v, 5);
    ...
    public void testDutchFlagPartitionNoEqualElements() {
      Vector<Integer> v = new Vector<>(Arrays.asList(1, 2, 3, 7, 8, 9));
      Sort.DutchFlagPartition(v, 5);
  ...
  @Nested
  @DisplayName("MaxN(Vector<Integer> v, int n) tests")
  class MaxNTests {
    ...
    public void testMaxNOne() {
      Vector<Integer> v = new Vector<>(Arrays.asList(3, 1, 4, 1, 5, 9, 2, 6));
      Vector<Integer> result = Sort.MaxN(v, 1);
      Vector<Integer> expected = new Vector<>(Arrays.asList(9));
    ...
    public void testMaxNNormalCase() {
      Vector<Integer> v = new Vector<>(Arrays.asList(3, 1, 4, 1, 5, 9, 2, 6));
      Vector<Integer> result = Sort.MaxN(v, 3);
      Vector<Integer> expected = new Vector<>(Arrays.asList(9, 6, 5));
    ...
    public void testMaxNDescendingOrder() {
      Vector<Integer> v = new Vector<>(Arrays.asList(10, 5, 20, 15, 25));
      Vector<Integer> result = Sort.MaxN(v, 4);
      Vector<Integer> expected = new Vector<>(Arrays.asList(25, 20, 15, 10));
    ...
    public void testMaxNWithDuplicates() {
      Vector<Integer> v = new Vector<>(Arrays.asList(5, 5, 3, 5, 1, 2));
      Vector<Integer> result = Sort.MaxN(v, 3);
    ...
    public void testMaxNWithNegatives() {
      Vector<Integer> v = new Vector<>(Arrays.asList(-5, -1, -10, 3, 0, -2));
      Vector<Integer> result = Sort.MaxN(v, 3);
      Vector<Integer> expected = new Vector<>(Arrays.asList(3, 0, -1));
    ...
    public void testMaxNAllIdentical() {
      Vector<Integer> v = new Vector<>(Arrays.asList(7, 7, 7, 7, 7));
      Vector<Integer> result = Sort.MaxN(v, 3);
      Vector<Integer> expected = new Vector<>(Arrays.asList(7, 7, 7));
